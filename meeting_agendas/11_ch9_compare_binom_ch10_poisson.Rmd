...
author: "AG Schissler"
date: "3 Mar 2021 (*updated: `r Sys.Date()`)*"
output:
...
library(printr)
library(Bolstad)
## xaringan::inf_mr('11_ch9_compare_binom_ch10_poisson.Rmd')
```

# Hands-on Monte Carlo data collection

We will conduct simulation to approximate the sampling distribution of Frequentist and Bayesian estimator of $\pi$.

Each person will receive a value in $\pi_i \in \{0.1, 0.2, \ldots, 0.9\}$.

1. Please design an experiment in `R` to perform random binomial experiments with modeling parameters $Y_i \sim bin(\pi = \pi_i, n = 10)$.
2. Be ready to provide a simulated $Y_i$ when asked.
...
## Any questions over problem set 4, Ch. 7?
...
- Finish discussion of Ch. 9: Figure 9.2 ; Examples 9.1-9.3
- Begin discussion Ch. 10 time permitting
...
## MSE of Frequentist vs Bayes estimator of $\pi$

Please share some remarks about Figure 9.2.
...
# II. Analysis of "Hands-on" Monte Carlo
