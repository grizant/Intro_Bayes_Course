...
sleep <- c(10, 8, 7, 9, 8, 7.5, 5, 6.5, 7.5, 6, 11, 7, 8, 8.33, 8.25, 10, 6, 7, 8.5,8, 9, 9, 8, 9.5, 8, 9, 8.11, 7)
...
compute_mean_posterior(m = 7, s2 = 1, n = n, y_bar = y_bar, sigma2 = 1)
...
compute_mean_predictive(m = 7, s2 = 1, n = n, y_bar = y_bar, sigma2 = 1 )

## set.seed(44)
## y <- rnorm(n = 30, mean = 8, sd = 2)

Bolstad::normnp(x = sleep, m.x = 7, s.x = 1, sigma.x = 1, plot = TRUE)
compute_mean_posterior(m = 7, s2 = 1, n = length(sleep), y_bar = mean(sleep), sigma2 = 1)
...
## biases
arnold_bias <- sapply(X = mu_seq, FUN = compute_bayes_bias, m = 1000, s2 = 10^2, sigma2 = my_sigma2, n = my_n)
