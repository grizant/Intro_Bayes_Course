...
library(ggplot2)
p0 <- ggplot(data = reg_data,mapping =  aes(x = MidtermOne, y = MidtermThree))

p0 + geom_point(size = 5) + geom_abline(intercept = my_ls_soln$A0, slope = my_ls_soln$B)

ols_fit <- lm(MidtermThree ~ MidtermOne, data = reg_data)
