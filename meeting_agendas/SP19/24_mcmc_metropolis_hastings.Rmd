...
## What is Markov Chain Monte Carlo (MCMC) and how do we use it to do Bayesian inference?

### Start-of-class work (5 - 10 min)

## I. Introduction to Markov Chains (Ch.20; 10 - 15 min)
...
## II. Markov Chain Monte Carlo (MCMC) to sample a target distribution  (20.1; 30 - 45 min)
...
sigma * sqrt(pi /2)
```
## III. MCMC sampling demonstration (20.2; 10 - 15 min)

### [mcmc demo](https://chi-feng.github.io/mcmc-demo/)

## Closing (5 - 10 min)

Answer the essential question, "What is Markov Chain Monte Carlo (MCMC) and how do we use it to do Bayesian inference?".
