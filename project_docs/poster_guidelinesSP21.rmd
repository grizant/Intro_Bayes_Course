...
3. **Background** Provide detail here that puts the problem into context. Possible topics include: summary of related studies, current policies and practices, and descriptions of relevant physical/ biological models.
