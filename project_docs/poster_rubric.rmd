---
title: "Grading rubric: Poster rubric"
...
```{r, echo = FALSE}
text_tbl <- data.frame(
  `Point Value Label` = c("Computation: Perform computations necessary for the data analysis", "Analysis: Choose and carry out analysis appropriate for data and context. MUST USE BAYESIAN STATISTICS!", "Synthesis: Bring together the analysis and interpret results in context", "Visual: Communicate findings graphically clearly, precisely, and concisely", "Written: Communicate findings in writing clearly, precisely, and concisely"),
