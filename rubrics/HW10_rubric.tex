...
{\large Please complete exercises Ch.13 \#1,2,4,6,15,16 in Bolstad \& Curran. I selected these problems to give deliberate practice towards mastering learning outcome 3 --- \emph{students will conduct Bayesian inference for parameters of discrete and continuous random variables}. All exercises provide practice evaluating approaches to estimate and test hypotheses for the differences in two normal mean parameters. This homework features some small data sets that you may use software to analyze. Please include the R code you used in your report instead of saying something like ``I used R'' or just reporting output.}
