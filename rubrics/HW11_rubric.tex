...
{\large Please complete exercises Ch.14 \#1,2,4,7,C1-C4 in Bolstad \& Curran. I selected these problems to give deliberate practice towards mastering learning outcome 4 --- \emph{students will conduct Bayesian inference parameters in linear regression}. All exercises provide practice fitting and interpreting simple (one predictor) linear regression in Bayesian manner. This homework features some small data sets that you may use software to analyze. Please include the R code you used in your report instead of saying something like ``I used R'' or just reporting output.}
