...
{\large Please complete exercises Ch.9 \#1-3,C1 in Bolstad \& Curran. I selected these problems to give deliberate practice towards mastering learning outcome 6 --- \emph{students will compare Frequentist/Bayesian approaches in statistical inference}. All exercises provide practice evaluating approaches to estimate and test hypotheses for a binomial proportion. This homework features an elaborate Monte Carlo exercise to compare MSE of estimators.  You have the option of calculating these quantities by hand (using formula/tables) or by writing R code --- just be sure to justify your work well (such as include R code snippets in your report).}
