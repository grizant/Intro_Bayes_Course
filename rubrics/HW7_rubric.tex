...
{\large Please complete exercises Ch.10 \#2, C1,C3-C6 in Bolstad \& Curran. I selected these problems to give deliberate practice towards mastering learning outcome 3 --- \emph{students will conduct Bayesian inference for parameters of discrete and continuous random variables}. All exercises provide practice evaluating approaches to estimate and test hypotheses for the Poisson mean parameter. This homework features several computer exercises to help you build intuition rapidly. Please include the R code you used in your report instead of saying something like ``I used R''.}
