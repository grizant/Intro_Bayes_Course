...
{\large Please complete the exercises in accompanying document. I created these problems to give deliberate practice towards mastering learning outcome 5 --- \emph{students will apply computational techniques to conduct Bayesian inference, including Markov Chain Monte Carlo}. All exercises provide practice sampling from a target probability density. This homework features small data sets that you may use software to analyze. Please include the R code you used in your report instead of saying something like ``I used R'' or just reporting output.}
