...
\newcommand{\classtimes}{Tue,Thu 9:00am - 10:00am}
...
\begin{enumerate}
\item Students will demonstrate mastery of the concepts that underly modern methods of Bayesian analysis, and critically assess the assumptions associated with different statistical models.
\item Students will be able to perform a modern Bayesian analysis using professional statistical packages (e.g., \textsf{R} and \textsf{Stan}) and interpret the results.
\item Students will be able to synthesize course concepts to apply Bayesian modeling techniques to real-world data to facilitate aid scientific inquiry.
\end{enumerate}
