...
This course requires the use of statistical software. Students are assumed to have access to a computer with the free software R (\url{http: www.r-project.org}) installed. Students using R are encouraged to use the front-end RStudio (\url{http:www.rstudio.com}).
