...
The course has a weighted grading scheme. There are three categories of assignments. Table 1 shows the percentages for each category and the number of assignments (n).
...
<div class="week">`r advdate(mon, 5)`: Ch. 7-8 Continuous RVs and Bayesian inference for binomial proportion </div>
